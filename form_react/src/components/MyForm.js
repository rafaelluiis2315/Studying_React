...
const MyForm = ( {user} ) => {
    ...
    const handleSubmit = (event) => {
        ...
        console.log(`Nome: ${name}`, `E-mail: ${email}`, `Bio: ${bio}`, `Bio: ${role}`)
        // limpando o form
        setEmail('')
        setName('')
        setBio('')
        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label>
                    ...
                    <textarea name="bio" placeholder="Decricao do usuario" onChange={(e) => setBio(e.target.value)} value={ bio }></textarea>
                </label>
                <label>
